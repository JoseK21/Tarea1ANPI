...
Pag.3
Ecuación (13)
Ejemplo : [xaprox, iter] = sne_ud_5("x^3 + 6*x^2 - 18",3,0.0001, 1)

 CONSISTE EN
   un método multipunto cúbico, caso especial del método multipunto propuesto por Ostrowski.
 ENTRADAS
   f : función
   x0 : valor inicial
   tol : tolerancia
...
%}
function [x0, itr] = sne_ud_5(f, x0, tol, graf = 1)
  pkg load symbolic;
